...
model = load_model(os.path.join(MODEL_PATH,'cgan_generator_128_4image.h5'), compile=False)

latent_points, labels = generate_latent_points(4, 4)

# specify labels
labels = asarray([x for _ in range(4) for x in range(1)])
