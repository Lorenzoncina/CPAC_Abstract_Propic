...
feature_space_10 = feature_space[:10]
...
#mood_labels_10 = mood_labels[:10]


"""
Analysis over 30 songs
"""
l = len(mood_labels)

num_H = mood_labels.count("Happy")
num_A = mood_labels.count("Angry")
num_S = mood_labels.count("Sad")
num_R = mood_labels.count("Relaxed")

#print("H:", str(num_H), "A:", str(num_A), "S:", str(num_S), "R:", str(num_R))
...
#numeri = num_H +"," +num_A+ "," +num_S+","+num_R
print(str(num_H) +"," +str(num_A)+ "," +str(num_S)+","+str(num_R))
